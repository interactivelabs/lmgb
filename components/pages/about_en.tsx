  ...
  <PageLangLayout>
    <div className="md:w-1/2 lg:w-1/2">
      ...
      <p className="mt-4">
        ...
        underrepresented specially on the top companies and I&apos;m sure is not
        a lack of talent but just the need of a bit more preparation and have
        someone to lend you a hand, so if you are interested please contact me.
      </p>
    </div>
  </PageLangLayout>
);
