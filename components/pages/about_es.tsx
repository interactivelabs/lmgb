    ...
    <div className="md:w-1/2 lg:w-1/2">
      ...
      <div className="mt-4">
        ...
        <p className="mt-4">
          ...
          nivel y estoy seguro que no es falta de talento, es solo un poco mas
          de preparacion y alguien que te dé un empujoncito, así que si tu eres
          una persona interesada por favor no dudes en ponerte en contacto.
        </p>
      </div>
    </div>
  </PageLangLayout>
